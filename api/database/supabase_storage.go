...
func SubirAStorageSupabase(fileHeader *multipart.FileHeader, bucketName, filePath string) (string, error) {
	...
	// Si es imagen y detectó como octet-stream, intentar detectar por extensión
	...
	// 4. Construir la URL correcta para Supabase Storage API
	// Formato: https://PROJECT.supabase.co/storage/v1/object/BUCKET_NAME/PATH
	...
	// 5. Crear la petición POST con el archivo en el body (NO multipart)
	...
	// Formato: https://PROJECT.supabase.co/storage/v1/object/public/BUCKET_NAME/PATH
